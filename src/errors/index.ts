 ...
 */
export type ErrorSource = 'intervals' | 'whoop' | 'trainerroad' | 'lastfm' | 'google-weather' | 'google-air-quality' | 'google-pollen' | 'google-elevation' | 'google-geocoding' | 'date_parser';
