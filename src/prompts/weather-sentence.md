...
- If the source data includes information on headwind and tailwind, describe the predominant one as "[adjective] [headwind|tailwind]", e.g. "mostly headwind", "slight tailwind", "strong headwind".
