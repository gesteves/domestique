...
This document describes the plain-text syntax for creating structured cycling workouts in Intervals.icu. You **MUST** use this exact format to generate workout files that can be imported directly. Omit any other text besides the workout syntax itself, such as a preample or explanation of the workout, as that will prevent the workout from syncing correctly to Zwift.
