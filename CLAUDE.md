...
# Google APIs (Weather API + Air Quality API + Pollen API; same key, all three must be enabled on the GCP project)
GOOGLE_API_KEY=             # Google Cloud API key (used for Weather API, Air Quality API, Pollen API, and other Google services)
